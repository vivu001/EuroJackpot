...
public class Menu {
    ...
    public void createResults() {
        ...
        Integer[][] numbersResults =
                {
                        {3, 9, 10, 19, 42}, {5, 7, 15, 19, 46}, {20, 27, 33, 35, 25}, {8, 26, 48, 47, 50}, {10, 12, 35, 36, 43},
                        {7, 8, 20, 35, 38}, {1, 23, 40, 41, 42}, {20, 27, 37, 41, 45}, {18, 25, 29, 35, 38}, {1, 15, 34, 48, 50},
                        {2, 15, 36, 41, 49}, {31, 32, 45, 47, 49}, {3, 8, 30, 46, 48}, {6, 11, 38, 41, 44}, {2, 4, 20, 21, 50}
                };

        Integer[][] superNumbersResults =
                {
                        {1, 7}, {3, 8}, {5, 9}, {4, 7}, {2, 15},
                        {5, 9}, {2, 12}, {1, 7}, {5, 6}, {6, 10},
                        {7, 8}, {10, 9}, {1, 3}, {9, 10}, {9, 10}
                };
